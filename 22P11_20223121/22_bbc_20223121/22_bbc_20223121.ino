...
// Servo adjustment
#define _DUTY_MAX 2007  // Servo angle: D degree
#define _DUTY_NEU 1398  // Servo angle: 0 degree
#define _DUTY_MIN 736   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 99.2 // Replace with |D - E| degree
...
// output the read value to the serial port
    ...
    Serial.print("DUTY TARGET:"); Serial.print(duty_target);
    Serial.print(",DIST:"); 
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 953 + -4.55*x + 7.79E-03*x*x + -4.7E-06*x*x*x;
}
